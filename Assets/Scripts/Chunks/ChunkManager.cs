...
namespace Chunks
{
    ...
    {
        // Other Managers
        public readonly ClientCollisionManager ClientCollisionManager = new ClientCollisionManager();
        ...
        private void FixedUpdate()
        {
            ...
            if (!GlobalDebugConfig.StaticGlobalConfig.disableCollisions)
                ClientCollisionManager.GenerateCollisions(ClientChunkMap, _playerFlooredPosition, _playerHasMoved);
        }
